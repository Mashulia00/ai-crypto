  ...
  const steps: Step[] = [
    {
      title: "Сбор данных",
      desc:
        "Цены, объёмы, деривативные метрики, рыночные режимы. Данные нормализуются и фильтруются.",
    },
    {
      title: "AI-сигналы",
      desc:
        "Классификация режимов: тренд, флэт, высокая волатильность. Вероятностные сигналы входа/выхода.",
    },
    {
      title: "Управление сделками",
      desc:
        "Размер позиции, стоп-лосс, тейк-профит, риск на сделку. Лимиты на уровне портфеля.",
    },
    {
      title: "Мониторинг 24/7",
      desc:
        "Оповещения о событиях, проверка состояния стратегий, контроль соединения и лимитов биржи.",
    },
    {
      title: "Безопасность",
      desc:
        "В демо — только чтение. В продакшене — торговые ключи без права вывода средств.",
    },
  ];
    ...
    <section ref={sectionRef} className="relative mx-auto max-w-6xl px-4 py-10 md:py-12">
      ...
      <SectionReveal>
        <h1 className="text-balance text-3xl font-semibold tracking-tight md:text-4xl">
          Как это <span className="mark-underline mark-underline--thick">работает</span>
        </h1>
        <p className="mt-3 max-w-3xl text-platinum-300">
          От потоков данных — к сигналам и контролю рисков. Создано mobile first
          с акцентом на прозрачность и надёжность.
        </p>
      ...
      <div className="mt-10 border-t border-white/10 pt-8">
        <div className="cta-cyber rounded-2xl p-5 md:p-6">
          <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <span className="badge-chip">Демо и прозрачные графики</span>
              <h2 className="mt-3 text-xl font-semibold">
                Хотите увидеть результаты?
              </h2>
              <p className="mt-1 text-platinum-300">
                Перейдите на страницу результатов — PnL и просадка в демо с пояснениями.
              </p>
            </div>
            <Link href="/performance">
              <Button className="cta-button">
                Смотреть демо результатов
