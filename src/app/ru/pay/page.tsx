    ...
    <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
      <SectionReveal>
        ...
        <p className="mt-2 text-platinum-300">
          Тариф: <span className="badge-chip">{plan}</span> • Период:{" "}
      ...
      <div className="mt-6 grid gap-5">
        <div className="glass rounded-2xl p-5">
          ...
          <p className="mt-1 text-platinum-300">
            MetaMask / другие совместимые кошельки (USDT/USDC).
          </p>
          <div className="mt-3 flex flex-wrap gap-3">
            <Button className="bg-aqua text-ink" asChild>
              <Link href="#">Подключить MetaMask</Link>
            </Button>
            <Button variant="outline" asChild className="border-white/10">
              <Link href="#">Другие кошельки</Link>
            </Button>
          </div>
        </div>

        <div className="glass rounded-2xl p-5">
          <h2 className="text-lg font-semibold">Через биржу</h2>
          <p className="mt-1 text-platinum-300">
            Поддерживаются: Binance, Coinbase, Kraken, OKX, Bybit.
          </p>
          ...
          <p className="mt-3 text-sm text-platinum-400">
            Демо-страница. В реальной версии здесь будет подключение к платёжному шлюзу или счёту.
          </p>
        </div>
