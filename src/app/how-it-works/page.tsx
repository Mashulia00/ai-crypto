...
/* scroll progress усередині секції (0..1) */
...
/* показ елемента при вході у в’юпорт */
...
/* картка кроку з mobile-tap ефектами */
function StepCard({
  index,
  title,
  desc,
  ...
  const steps: Step[] = [
    {
      title: "Збір даних",
      desc:
        "Ціни/об’єми, деривативні метрики, режими ринку. Дані нормалізуються та фільтруються.",
    },
    {
      title: "Сигнали ШІ",
      desc:
        "Класифікація режимів (тренд/флет/висока вола), імовірнісні сигнали входу/виходу.",
    },
    {
      title: "Менеджмент угод",
      desc:
        "Розмір позиції, стоп-лос, тейк-профіт, ризик на угоду. Обмеження за портфелем.",
    },
    {
      title: "Моніторинг 24/7",
      desc:
        "Алерти про події, health-чеки стратегій, контроль підключень та лімітів бірж.",
    },
    {
      title: "Безпека",
      desc:
        "У демо — лише читання. Для продакшену — ключі з правами «trade», без можливості виводу коштів.",
    },
  ];
    ...
    <section ref={sectionRef} className="relative mx-auto max-w-6xl px-4 py-10 md:py-12">
      ...
      <SectionReveal>
        <h1 className="text-balance text-3xl font-semibold tracking-tight md:text-4xl">
          Як це <span className="mark-underline mark-underline--thick">працює</span>
        </h1>
        <p className="mt-3 max-w-3xl text-platinum-300">
          Від потоків даних — до сигналів і ризик-контролю. Побудовано mobile-first
          з акцентом на прозорість і надійність.
        </p>

        {/* прогрес-лінія секції */}
      ...
      <div className="mt-10 border-t border-white/10 pt-8">
        <div className="cta-cyber rounded-2xl p-5 md:p-6">
          <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <span className="badge-chip">Демо та прозорі графіки</span>
              <h2 className="mt-3 text-xl font-semibold">
                Хочете побачити результати?
              </h2>
              <p className="mt-1 text-platinum-300">
                Перейдіть до продуктивності — живі PnL/Drawdown з поясненнями.
              </p>
            </div>
